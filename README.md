...
- **Contact:** bryan@southpillarllc.com

This repository is the source of the South Pillar website. It also serves as the machine-readable canonical mirror for AI agents — and for humans who prefer markdown — of what South Pillar does, who it's for, and how to engage.

---

## What's in here

- `index.html`, `methodology.html`, `engagements.html`, `writing.html`, `about.html`, `contact.html` — the six pages of the public site.
...
See [llms.txt](./llms.txt) for a structured summary and [ai.txt](./ai.txt) for content-use permissions.
